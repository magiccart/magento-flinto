 ...
 * @@Modify Date: 2016-06-07 23:05:30
 * @@Function:
 */

?>
<?php
class Magiccart_Alothemes_Adminhtml_Export_PermissionsController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ...
            ->_title(Mage::helper('alothemes')->__('Manage Export Permissions Blocks'))
            ->_addBreadcrumb(Mage::helper('alothemes')->__('Manage Export Permissions Blocks'), Mage::helper('alothemes')->__('Manage Export Permissions Block'));
        return $this;
    }
    ...
    {
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('alothemes/adminhtml_export_permissions'));
        $this->renderLayout();
    }
