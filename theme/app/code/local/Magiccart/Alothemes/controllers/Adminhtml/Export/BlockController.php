 ...
 * @@Modify Date: 2016-06-07 23:29:14
 * @@Function:
 */

?>
<?php
class Magiccart_Alothemes_Adminhtml_Export_BlockController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ...
            ->_title(Mage::helper('alothemes')->__('Manage Export Static Block'))
            ->_addBreadcrumb(Mage::helper('alothemes')->__('Manage Export Static Block'), Mage::helper('alothemes')->__('Manage Export Static Block'));
        return $this;
    }
    ...
    {
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('alothemes/adminhtml_export_block'));
        $this->renderLayout();
    }
