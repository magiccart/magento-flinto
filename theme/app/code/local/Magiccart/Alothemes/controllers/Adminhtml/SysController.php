 ...
 * @@Modify Date: 2016-06-16 10:57:01
 * @@Function:
 */

?>
<?php
class Magiccart_Alothemes_Adminhtml_SysController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ...
            ->_title(Mage::helper('alothemes')->__('Manage Export System Config'))
            ->_addBreadcrumb(Mage::helper('alothemes')->__('Manage Export System Config'), Mage::helper('alothemes')->__('Manage Export System Config'));
        return $this;
    }
    ...
    public function editAction() 
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('alothemes/adminhtml_sys_edit'))
            ->_addLeft($this->getLayout()->createBlock('alothemes/adminhtml_sys_edit_tabs'));
        $this->renderLayout();
    }
