 ...
 * @@Modify Date: 2016-06-07 23:05:38
 * @@Function:
 */

?>
<?php
class Magiccart_Alothemes_Adminhtml_Export_SlideController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ...
            ->_title(Mage::helper('alothemes')->__('Manage Export Magicslider'))
            ->_addBreadcrumb(Mage::helper('alothemes')->__('Manage Export Magicslider'), Mage::helper('alothemes')->__('Manage Export Magicslider'));
        return $this;
    }
    ...
    {
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('alothemes/adminhtml_export_slide'));
        $this->renderLayout();
    }
