 ...
 * @@Modify Date: 2016-06-07 23:37:56
 * @@Function:
 */

?>
<?php
class Magiccart_Alothemes_Adminhtml_Export_MenuController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ...
            ->_title(Mage::helper('alothemes')->__('Manage Export Extra Menu'))
            ->_addBreadcrumb(Mage::helper('alothemes')->__('Manage Export Extra Menu'), Mage::helper('alothemes')->__('Manage Export Extra Menu'));
        return $this;
    }
    ...
    {
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('alothemes/adminhtml_export_menu'));
        $this->renderLayout();
    }
