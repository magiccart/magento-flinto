 ...
 * @@Modify Date: 2016-06-07 23:55:27
 * @@Function:
 */
?>
<?php
class Magiccart_Alothemes_Block_Adminhtml_Install_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset->addField('theme', 'select', array(
			...
			'name'      => 'theme',
			'required' => true,
			'values'    => Mage::getModel('alothemes/import_theme')->toOptionArray(),
		));
...
*/
	  ...
	  //       $storeIdsActive = Mage::helper('alothemes')->getStoreActiveTheme();
