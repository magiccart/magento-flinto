...
?>
<?php
class Magiccart_Alothemes_Block_Adminhtml_Install_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('form_section', array(
			...
			'content'   => $this->getLayout()->createBlock('alothemes/adminhtml_install_edit_tab_form')->toHtml(),
		));
